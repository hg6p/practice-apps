...
export type PostsQuery = { __typename?: 'Query', posts: { __typename?: 'PaginatedPost', hasMore: boolean, posts: Array<{ __typename?: 'Post', createdAt: string, id: number, title: string, points: number, textSnippet: string }> } };
